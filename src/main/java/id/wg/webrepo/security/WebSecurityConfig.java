...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers(HttpMethod.DELETE, "/api/majors/**").hasAnyRole(Constants.SUPERADMIN, Constants.ADMIN)
                ...
                .antMatchers(HttpMethod.POST, "/api/theses/**").hasAnyRole(Constants.SUPERADMIN, Constants.ADMIN)
                .antMatchers(HttpMethod.PUT, "/api/theses/**").hasAnyRole(Constants.SUPERADMIN, Constants.ADMIN)
